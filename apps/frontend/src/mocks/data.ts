...
export const MOCK_EVENTS = [
  { id: UUIDS.EVT_SGML, title: '三顾茅庐', description: '刘备三次前往隆中拜访诸葛亮，恳请其出山辅佐。', start_date: '0207-01-01T00:00:00Z', end_date: '0207-01-01T00:00:00Z', display_time: '建安十二年（公元207年）', time_type: 'POINT', sort_date: '0207-01-01T00:00:00Z', granularity: 'YEAR', event_type: 'CAREER', ...EVT_BASE },
  { id: UUIDS.EVT_LZD, title: '隆中对', description: '诸葛亮在隆中为刘备分析天下形势，提出"先取荆州为家，再取益州成鼎足之势，然后图中原"的战略规划。', start_date: '0207-01-01T00:00:00Z', end_date: '0207-12-01T00:00:00Z', display_time: '建安十二年（公元207年）', time_type: 'PERIOD', sort_date: '0207-06-01T00:00:00Z', granularity: 'YEAR', event_type: 'CAREER', ...EVT_BASE },
  { id: UUIDS.EVT_CBZZ, title: '赤壁之战', description: '孙刘联军在赤壁以少胜多，大破曹操大军。诸葛亮与周瑜共同策划，利用火攻战术。', start_date: '0208-10-01T00:00:00Z', end_date: '0208-11-01T00:00:00Z', display_time: '建安十三年（公元208年）冬', time_type: 'PERIOD', sort_date: '0208-10-01T00:00:00Z', granularity: 'MONTH', event_type: 'HISTORICAL', ...EVT_BASE },
  { id: UUIDS.EVT_JJZ, title: '借荆州', description: '赤壁之战后，诸葛亮建议刘备趁机占据荆州。后孙权多次索要未果。', start_date: '0209-01-01T00:00:00Z', end_date: '0210-12-01T00:00:00Z', display_time: '建安十四至十五年（公元209-210年）', time_type: 'PERIOD', sort_date: '0209-01-01T00:00:00Z', granularity: 'YEAR', event_type: 'CAREER', ...EVT_BASE },
  { id: UUIDS.EVT_PDNZ, title: '平定南中', description: '诸葛亮亲率大军南征，七擒孟获，平定南中叛乱，巩固蜀汉后方。', start_date: '0225-03-01T00:00:00Z', end_date: '0225-12-01T00:00:00Z', display_time: '建兴三年（公元225年）', time_type: 'PERIOD', sort_date: '0225-06-01T00:00:00Z', granularity: 'YEAR', event_type: 'HISTORICAL', ...EVT_BASE },
  { id: UUIDS.EVT_BF, title: '北伐', description: '诸葛亮率军五次北伐中原，意图恢复汉室。虽未成功，但充分展现了其军事才能。', start_date: '0228-01-01T00:00:00Z', end_date: '0234-08-01T00:00:00Z', display_time: '建兴六年至十二年（公元228-234年）', time_type: 'PERIOD', sort_date: '0228-01-01T00:00:00Z', granularity: 'YEAR', event_type: 'HISTORICAL', ...EVT_BASE },
  { id: UUIDS.EVT_KCJ, title: '空城计', description: '街亭失守后，司马懿大军兵临西城。诸葛亮大开城门，以空城之计吓退司马懿。', start_date: '0228-05-01T00:00:00Z', end_date: '0228-05-01T00:00:00Z', display_time: '建兴六年（公元228年）', time_type: 'POINT', sort_date: '0228-05-01T00:00:00Z', granularity: 'YEAR', event_type: 'HISTORICAL', ...EVT_BASE },
  { id: UUIDS.EVT_ZSZJ, title: '挥泪斩马谡', description: '马谡违反军令导致街亭失守，诸葛亮虽爱惜其才，但为严明军纪，挥泪将其处斩。', start_date: '0228-06-01T00:00:00Z', end_date: '0228-06-01T00:00:00Z', display_time: '建兴六年（公元228年）夏', time_type: 'POINT', sort_date: '0228-06-01T00:00:00Z', granularity: 'YEAR', event_type: 'CAREER', ...EVT_BASE },
  { id: UUIDS.EVT_CSS, title: '出师表', description: '诸葛亮在北伐前上呈《出师表》于后主刘禅，陈述北伐的必要性，表达对蜀汉的忠心。"鞠躬尽瘁，死而后已"即出于此。', start_date: '0227-03-01T00:00:00Z', end_date: '0227-03-01T00:00:00Z', display_time: '建兴五年（公元227年）', time_type: 'POINT', sort_date: '0227-03-01T00:00:00Z', granularity: 'YEAR', event_type: 'CREATION', ...EVT_BASE },
  { id: UUIDS.EVT_MNLN, title: '木牛流马', description: '诸葛亮为提高北伐后勤运输效率，发明木牛和流马两种运输工具，极大地改善了蜀军的补给能力。', start_date: '0230-01-01T00:00:00Z', end_date: '0231-06-01T00:00:00Z', display_time: '建兴八至九年（公元230-231年）', time_type: 'PERIOD', sort_date: '0230-06-01T00:00:00Z', granularity: 'YEAR', event_type: 'CREATION', ...EVT_BASE },
  { id: UUIDS.EVT_WZY, title: '五丈原', description: '诸葛亮最后一次北伐时，在五丈原病逝，享年五十四岁。出师未捷身先死，长使英雄泪满襟。', start_date: '0234-08-01T00:00:00Z', end_date: '0234-10-08T00:00:00Z', display_time: '建兴十二年（公元234年）秋', time_type: 'PERIOD', sort_date: '0234-09-01T00:00:00Z', granularity: 'MONTH', event_type: 'CAREER', ...EVT_BASE },
  { id: UUIDS.EVT_GZDZ, title: '官渡之战', description: '曹操与袁绍在官渡决战，以少胜多，奠定了统一北方的基础。', start_date: '0200-08-01T00:00:00Z', end_date: '0200-10-01T00:00:00Z', display_time: '建安五年（公元200年）', time_type: 'PERIOD', sort_date: '0200-09-01T00:00:00Z', granularity: 'MONTH', event_type: 'HISTORICAL', ...EVT_BASE },
  { id: UUIDS.EVT_CCDTH, title: '曹操病逝', description: '曹操在洛阳病逝，享年六十六岁。临终前嘱咐丧事从简。', start_date: '0220-03-15T00:00:00Z', end_date: '0220-03-15T00:00:00Z', display_time: '建安二十五年（公元220年）', time_type: 'POINT', sort_date: '0220-03-15T00:00:00Z', granularity: 'YEAR', event_type: 'DEATH', ...EVT_BASE },
]
