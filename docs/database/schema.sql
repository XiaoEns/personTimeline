...
CREATE INDEX idx_uf_person ON uploaded_files(person_id);
CREATE INDEX idx_uf_status ON uploaded_files(status);
CREATE INDEX idx_uf_created_at ON uploaded_files(created_at);


-- ============================================================
-- biography_text 表变更（v2 新增字段）
-- ============================================================
